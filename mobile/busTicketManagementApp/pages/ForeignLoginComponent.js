...
export default function ForeignLoginComponent({ navigation }) {
    ...
    const loginHandle=()=>{
        if(!email||!password){
          ...
          axios.post(`http://localhost:9000/api/v1/auth/foreign/login`, {
            email: email,
            password: password
          }).then(response => {
  ...
  return (
    <View style={styles.outerContainer}>
      <View style={styles.loginContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ForeignSignUp')}>
